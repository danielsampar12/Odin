...
SYSTEM_PROMPT=$(cat "$ROLES_DIR/$ROLE.md")
...
cp "$ROLES_DIR/baldur.md" "$AICHAT_CONFIG_DIR/roles/baldur.md"
cp "$ROLES_DIR/tyr.md"    "$AICHAT_CONFIG_DIR/roles/tyr.md"
cp "$ROLES_DIR/thor.md"   "$AICHAT_CONFIG_DIR/roles/thor.md"
cp "$ROLES_DIR/loki.md"   "$AICHAT_CONFIG_DIR/roles/loki.md"
